...
The authorization make with an API key, which generate by an [automatic tool](apiGenerator/README.md), by inserting it as Basic Authentication, while the "id" is the username and the "API Key Secret" is the password.
