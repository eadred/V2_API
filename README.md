...
METHOD: GET <br \> <br \>
groupid: if the request is made without the security group id, then the entire security groups attached to Dome9 will be returned.
...
Change the protection to Read Only or Full Protection.

URL: https://api.dome9.com/CloudSecurityGroup/{groupId}/protection-mode <br \>
METHOD: POST <br \>
groupid: The groupid can be either the internal id or the external id. <br \>
...
* cloudAccountId (string, optional): Dome9 Cloud Account ID.
* services (object, optional): an option to add service to the security group.
